...
#define ESBE_HAN 0.75 //水面の雲の反射の程度。あげると強調。下げると控えめ。
#define C_REF//水面の雲の反射
//光源
#define ESBE_LIGHT
#define ESBE_LIGHT_A vec3(0.990,0.388,0.0)
#define ESBE_LIGHT_B vec3(0.995,0.474,0.0)
//(r,g,b)
//陰
#define ESBE_SHADOW vec3(0.05,0.05,0.05)//影の色
#define ESBE_SIDE_SHADOW vec3(0.05,0.05,0.05)//ブロック側面の影の色
#define ESBE_SHADOW_DARKNESS 0.85//影の濃さ。あげると濃く、下げると薄く
#define ESBE_FLAT_SHADING//フラットシェーディング
//#define ESBE_UNEVEN 0.5//立体的なテクスチャ
#define EN_SH 0.825 //エンティティの横の明るさ。下げると暗く、あげると明るく
//日光
